                    ...
                    <div className="profile-popup">
                        ...
                        <div className="buttons-box">
                            ...
                            onClick={() => {
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><g fill="#FFF"><path d="M476.352 247.979l-85.333-74.667c-3.136-2.731-7.616-3.392-11.435-1.685a10.64 10.64 0 00-6.251 9.707v32H256c-5.888 0-10.667 4.779-10.667 10.667v64c0 5.888 4.779 10.667 10.667 10.667h117.333v32A10.675 10.675 0 00384 341.335c2.539 0 5.035-.896 7.019-2.645l85.333-74.667c2.325-2.027 3.648-4.949 3.648-8.021s-1.323-5.997-3.648-8.023z"/><path d="M341.333 320H256c-17.643 0-32-14.357-32-32v-64c0-17.643 14.357-32 32-32h85.333c5.888 0 10.667-4.779 10.667-10.667V32c0-17.643-14.357-32-32-32H64C46.357 0 32 14.357 32 32v448c0 17.643 14.357 32 32 32h256c17.643 0 32-14.357 32-32V330.667c0-5.888-4.779-10.667-10.667-10.667z"/></g></svg>
                                <span>Logout</span>
                            </button>
                        </div>
                    </div>
